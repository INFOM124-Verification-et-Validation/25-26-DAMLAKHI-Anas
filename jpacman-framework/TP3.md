...
| **Collidee**    | Pellet(last one)| Ghost                  | Pellet                  | wall            |
| **Consequence** | pellet disappears, player wins     | pacman dies, game ends | pellet disappears, +10p | nothing happens |
...
(on essaie d'arriver a 100% de coverage en faisant nos tests)
